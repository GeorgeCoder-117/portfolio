(function () {
	...
	<div class="wrapper">
		...
		<section>
			...
			<div class="aboutme-wrapper">
				...
				<div class="aboutme">
					<p>Desarrollador web y desarrollador de apps (React Native) con casi 5 años de experiencia en el campo, front end y back end, apasionado por la tecnología.</p>
				</div>
			</div>			
		</section>
	...
	<div class="wrapper">
		...
		<section>
			...
			<div class="section-title" id="enlaces">
				<h1>Sitios web</h1>
				<small>Últimos proyectos realizados</small>
				<small>Tenga en cuenta que algunos proyectos el Cliente esta pendiente de subir imágenes<br>
					lo que puede variar la experiencia en los dispositivos, gracias por su comprensión.
				</small>
		...
		<section>
			...
			<div class="experience-wrapper">
				...
				<li class="item" id="scholastico">
					...
					<div class="experience">
						<p>Desarrollador Web Full Stack y desarrollador de apps (React Native)</p>
	...
	window.onload = function () {
		...
		langBtn.addEventListener('click', () => {
			...
			if (langBtnActive == 0) {
				...
				divEnlaces.querySelector("h1").innerHTML = "<h1>WebSites</h1>";
				let divEnlacesSmall = divEnlaces.getElementsByTagName("small");
				divEnlacesSmall[0].innerHTML = "Last projects done";
				divEnlacesSmall[1].innerHTML = "Please consider that some clients doesn´t update all their images yet on the web, so the experience maybe will be affected.";
				divEnlacesSmall[2].innerHTML = "Click below";
				let divEnlacesAnchor = divEnlaces.getElementsByTagName("a");
				divEnlacesAnchor[0].innerHTML = "<b>WebSites for small/local companies</b>";
				divEnlacesAnchor[1].innerHTML = "<b>WebSites for National/MultiNational companies</b>";
